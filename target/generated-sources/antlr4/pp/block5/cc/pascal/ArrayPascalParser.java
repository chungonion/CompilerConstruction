...
public class ArrayPascalParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "ARRAY", "OF", "'..'", "'['", "']'", "AND", "BEGIN", "BOOLEAN", 
		"INTEGER", "DO", "ELSE", "END", "EXIT", "FALSE", "FUNC", "IF", "IN", "THEN", 
		"NOT", "OR", "OUT", "PROC", "PROGRAM", "TRUE", "VAR", "WHILE", "':='", 
		"':'", "','", "'.'", "'\"'", "'='", "'>='", "'>'", "'<='", "'{'", "'('", 
		"'<'", "'-'", "'<>'", "'+'", "'}'", "')'", "';'", "'/'", "'*'", "ID", 
		"NUM", "STR", "COMMENT", "WS"
	};
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 7:
				...
				setState(51); match(LSQ);
				setState(52); expr(0);
				setState(53); match(RSQ);
				}
				break;
			case 8:
				{
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			case ARRAY:
				...
				{
				setState(88); match(ARRAY);
				setState(89); match(LSQ);
				setState(90); bound();
				setState(91); match(DOTDOT);
				setState(92); bound();
				setState(93); match(RSQ);
				setState(94); match(OF);
				setState(95); type();
				}
				break;
			default:
	...
	public final StatContext stat() throws RecognitionException {
		...
		try {
			...
			case OUT:
				...
				{
				setState(174); match(OUT);
				setState(175); match(LPAR);
				setState(176); match(STR);
